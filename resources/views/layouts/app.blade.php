...
<!-- component -->
<section class="container mx-auto px-6 my-1 flex flex-wrap ">
  <div class="p-2 md:w-40 ">
      <a href="{{route('record')}}" class="flex items-center p-4 bg-blue-200 rounded-lg shadow-xs cursor-pointer hover:bg-blue-500 hover:text-gray-100">
        <img src="{{asset('assets/img/create.svg')}}" class="img-responsive w-5 h-4 mr-2" alt="">
                  <div>
            <p class=" uppercase text-sm leading-normal ">
              تۆماری ڕەچەتە
            </p>

<div>
    ...
    <div class="flex flex-wrap   justify-end  m-2 space-x-1">
        <div class="pt-2 relative text-gray-600">
            <input w                class="border-2  border-gray-300 bg-white h-10  px-5 pr-16 rounded-lg text-sm focus:outline-none focus:border-purple-500"
                type="search" name="search" placeholder="ناوی نەخۆش">
    ...
    <div class="flex flex-wrap   justify-end  m-2 space-x-1">
        ...
        <div class="pt-2 relative  text-gray-600">
            <input
                ...
                type="search"  name="search" placeholder="ژمارەی دانە">
            <a class="absolute right-0 top-0 mt-5 mr-4">
        ...
        <div class="pt-2 relative  text-gray-600">
            <input
                class="border-2  bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none focus:border-purple-500"
                type="search"  name="search" placeholder="تێبینی بەکارهێنان">
            <a class="absolute right-0 top-0 mt-5 mr-4">
                <img class="img-fluid w-4 h-4 " src="{{asset('assets/img/notes.svg')}}" alt="">
            </a>
        </div>

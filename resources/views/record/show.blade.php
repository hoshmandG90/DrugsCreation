          ...
          <div class="flex justify-between">
               <div class="flex">
                ...
                <button  class="p-1">
                    <div
                        class="flex items-center p-4 bg-green-200 rounded-lg shadow-xs cursor-pointer hover:bg-green-500 hover:text-gray-100">
                        <img src="{{asset('assets/img/checked.svg')}}" class="img-responsive w-5 h-4 mr-2" alt="">
                ...
                <div class="flex flex-wrap  justify-end  m-2 space-x-1">
                    <div class="pt-2 relative text-gray-600">
                        <input
                            ...
                            type="search" wire:model.defer="name_drug" name="search" placeholder="ناوی دەرمان">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100 ">
                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="mr-2">
                                        <img class="img-fluid w-4 h-4 " src="{{asset('assets/img/medicine.svg')}}" alt="">
                            ...
                            <td class="py-3 px-6 text-left ">
                              <div class=" items-center">
                                ...
                                <span class="bg-purple-200 text-gray-600 py-1 px-3 rounded-full text-xs text-white">{{$record->created_at->format('Y-m-d')}}</span>
                              </div>
                            </td>
                            <td class="py-3 px-6 text-left">
                                <div class="flex item-center ">
                                    ...
                                    <div  wire:click.prevent="ConfirmRecordsRemoval('{{$record->id}}')" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
